...
// Review is what the first submit of a confirm_submit action returns: a
...
func (e *Engine) Preview(ctx context.Context, in *Case, actor Actor, stage, action string, input ActInput) (*Review, error) {
	c := in.Clone()
